========================================================================
    KONSOLENANWENDUNG: CANFOXLogger-Projektübersicht
========================================================================

Diese CANFOXLogger-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die CANFOXLogger-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen CANFOXLogger.pch sowie eine vorkompilierte 
