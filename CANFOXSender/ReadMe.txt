========================================================================
    KONSOLENANWENDUNG: CANFOXSender-Projektübersicht
========================================================================

Diese CANFOXSender-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die CANFOXSender-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen CANFOXSender.pch sowie eine vorkompilierte 
