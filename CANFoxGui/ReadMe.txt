========================================================================
    ANWENDUNG: CANFoxGui-Projektübersicht
========================================================================

Diese CANFoxGui-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre CANFoxGui-Anwendung besteht.
...
Form1.h
    Enhält die Implementierung der Formularklasse und der InitializeComponent()-Funktion.
